...
//       const response = await AvailableITService.getTicket(ticketId);
//       if (response) {
...
//     e.preventDefault();
//     try {
//       await AvailableITService.updateTicket(ticketData);
//       navigate("/minorticketmanagement");
//     } catch (error) {
...
// export default UpdateMinorTicket;
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-3">
          ...
          <select className="form-select" id="status" name="status" value={ticketData.status || ''} onChange={handleInputChange} required>
            <option value="">Upadate Status</option>
