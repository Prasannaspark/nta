...
const  ConnectivityMediumPriority= () => {
...
useEffect(() => {
      ...
      const fetchTickets = () => {
        ConnectivityService.mediumPriority()
          .then(response => {
            setTickets(response);
      ...
      const fetchTicket = async (ticketId) => {
        try {
          const ticket = await ConnectivityService.getTicket(ticketId);
              ...
              {tickets.map(ticket => (
                <tr key={ticket.ticketId}>
                  ...
                  <td>
                    ...
                    <button className="btn btn-default"><Link to={`/UpdateConnectivityTickets/${ticket.ticketId}`}> Update </Link></button>
                  </td>
                </tr>
              ))}
            </tbody>
    ...
    export default ConnectivityMediumPriority;
