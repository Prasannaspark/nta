...
const  AdministrativeMediumPriority= () => {
...
useEffect(() => {
      ...
      const fetchTickets = () => {
        AdministrativeService.mediumPriority()
          .then(response => {
            setTickets(response);
      ...
      const fetchTicket = async (ticketId) => {
        try {
          const ticket = await AdministrativeService.getTicket(ticketId);
              ...
              {tickets.map(ticket => (
                <tr key={ticket.ticketId}>
                  ...
                  <td>
                    ...
                    <button className="btn btn-default"><Link to={`/UpdateAdministrativeTickets/${ticket.ticketId}`}> Update </Link></button>
                  </td>
                </tr>
              ))}
            </tbody>
    ...
    export default AdministrativeMediumPriority;
